...
//   return (
//     <div className={`fixed bottom-12 md:bottom-22 right-6 md:right-16 z-50 transition-all duration-500 ease-out ${visible ? 'opacity-100 translate-y-0 pointer-events-auto' : 'opacity-0 translate-y-4 pointer-events-none'}`}>
//       <a href={`https://wa.me/${phone}?text=${message}`} target='_blank' rel='noopener noreferrer' aria-label='Fale com Daniel no WhatsApp'>
//         <div className='relative'>
//           <div className='absolute inset-0 rounded-full animate-pulse-custom' style={{ backgroundColor: COR_DESTAQUE, opacity: 0.7 }}></div>
//           <div className='w-14 h-14 rounded-full flex items-center justify-center shadow-md' style={{ backgroundColor: COR_DESTAQUE }}>
  ...
  return (
    ...
    >
      <a
        ...
        aria-label="Fale com Daniel no WhatsApp"
      >
        <div 
          className="
            relative
        ...
        >
          <div
            ...
            style={{ backgroundColor: COR_DESTAQUE, opacity: 0.7 }}
          />
          <div
